function state = getJobStateFcn(cluster, job, state,uname,keyfile)
...
remoteConnection = getRemoteConnection(cluster, clusterHost, remoteJobStorageLocation,uname,keyfile);
try
