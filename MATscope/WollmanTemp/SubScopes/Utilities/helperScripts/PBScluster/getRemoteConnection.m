function remoteConnection = getRemoteConnection(cluster, clusterHost, remoteJobStorageLocation,uname,keyfile)
...
%                     (true/false).
if ~isequal(uname,'') &&  ~isequal(keyfile,'')
    username = uname
    useIdentityFile=true
    identityFilename=keyfile
    fileHasPassphrase=false
elseif isempty(javachk('awt'))
