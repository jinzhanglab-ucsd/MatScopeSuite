...
%Demo Scope Configs
Scp.DeviceNames.Objective = 'Objective';
% Scp.DeviceNames.AFoffset = 'TIPFSOffset';
Scp.DeviceNames.LightPath = {'Path','Label','State-0', 'State-1',  'State-2'};
Scp.ScopeName = 'Demo';
